                ...
                <div className="bank-info">
                  <div className="col-md-8">
                    ...
                    <div className="detail_bank">
                      ...
                      <p>
                        <button type="button" className="btn btn-default btn-xs" onClick={copyBCA}>
                  ...
                  <div className="col-md-8">
                    ...
                    <div className="detail_bank">
                      <h4>
                        A.N Rizki Wibisono Kristianto <br />
                        <br />
                        No Rek. {rekBNI}
                      </h4>
                      <p>
                        <button type="button" className="btn btn-default btn-xs" onClick={copyBNI}>
